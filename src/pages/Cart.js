...
//       // useEffect to update localStorage whenever the cart or totals change
// useEffect(() => {
...
//   }));
// }, [cart, totalPrice, discount, finalAmount]); // Dependencies
...
const Cart = () => {
    ...
    console.log(totalPriceforPayment)
        ...
        <span>{truncateString(item.name,30)}</span>
                      ...
                      <td className="align-middle">
                        <div className="input-group quantity mx-auto" style={{ width: '100px' }}>
                          <div className="input-group-btn">
                            <button 
                            style={{height:'25px',backgroundColor:'#FFD333',borderRadius:0}}
                            className="custom-button custom-summary btn btn-sm btn-primary btn-minus"
                            onClick={() => handleSubtractQuantity(item._id)}
                            >
                              <i className="fa fa-minus"></i>
              ...
              <form className="mb-30" action="">
                <div className="input-group">
                  ...
                  style={{borderColor:'white',height:'45px',marginLeft:'90px'}}
                   type="text" className="form-control border-0 p-4 mt-3" placeholder="Coupon Code" />
                  <div className="input-group-append" style={{marginRight:'-150px',width:'120px'}}>
                    <button className="custom-button custom-summary btn btn-primary mr-3" style={{backgroundColor:'#FFD333',color:'#3D464D',fontWeight:500}}>Apply Coupon</button>
                  </div>
                </div>
              </form>
              <h5 className="section-title position-relative text-uppercase mb-3" style={{marginTop:'30px'}}>
                <span className="custom-summary secondary pr-3" style={{
                  fontSize:'20px',
                  fontWeight:'bold',
                  marginLeft:'100px',
                  color:'#3D464D',
